        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里在加入购物车路由跳转之前，发请求，把购买产品的信息以请求的方式通知服务器，服务器进行响应存储 -->
  ...
  export default {
    ...
    methods:{
      ...
      changeSkuNum(event){
        ...
        // console.log("测试：输入数量后input组件的"+value)
      },
      ...
      async addShopCart(){
        ...
        // 2、服务器存储成功--进行路由传参
          // 路由跳转到成功添加页面
            ...
            //复杂的数据（产品信息），通过会话存储--不持久，会话结束数据消失； 
        ...
        // console.log('测试，派发时的数据：'+this.$route.params.skuid+','+this.skuNum);
      }
    }
